...
app.add_page(pages.publications_page, route=navigation.routes.PUBLICATIONS_ROUTE)
app.add_page(pages.projects_page, route=navigation.routes.PROJECTS_ROUTE)
